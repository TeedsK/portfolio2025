...
// Note: PROCESSING_DELAY_MS is no longer used in the main animation loop, so it's safe to remove.
// Note: TYPO_ANIMATION_DELAY_MS has been moved to src/config/animation.ts
